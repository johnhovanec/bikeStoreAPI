...
{
    public partial class InitialCreateFullDesign : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomePageIndex = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PwdResetToken = table.Column<string>(nullable: true),
                    PwdTokenTimeStamp = table.Column<DateTime>(nullable: true),
                    FailedLogins = table.Column<int>(nullable: true),
                    Type = table.Column<int>(nullable: false),
                    PwdTimeStamp = table.Column<DateTime>(nullable: true),
